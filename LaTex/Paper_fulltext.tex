...
at the work place and terms like `work-life-balance' and `Generation Y' imply changing perceptions of a pleasant working environment. Also \citet{andersson_happiness_2008}
...
In the working environment, health is not a trivial factor either. The \citet{who_global_1994} stresses the importance of health
\end{document}
